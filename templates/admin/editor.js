 ...
 *
 * It lives under templates/ so Twig's FilesystemLoader finds it. edit.twig
 * pulls it in with {{ source('admin/editor.js') }}, which reads the file *raw*
 * rather than rendering it — the braces below are never parsed as Twig — and
 * which also means a site's own templates/ can override it like any other
 * template.
 *
